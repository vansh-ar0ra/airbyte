...
from source_lamatic_google_drive.spec import SourceLamaticGoogleDriveSpec
from source_lamatic_google_drive.stream_reader import SourceLamaticGoogleDriveStreamReader
from source_lamatic_google_drive.parsers import source_lamatic_google_drive_parsers



class SourceLamaticGoogleDrive(FileBasedSource):
    def __init__(self, catalog: Optional[ConfiguredAirbyteCatalog], config: Optional[Mapping[str, Any]], state: Optional[TState]):
        super().__init__(
            stream_reader=SourceLamaticGoogleDriveStreamReader(),
            spec_class=SourceLamaticGoogleDriveSpec,
            catalog=catalog,
            config=config,
            state=state,
            parsers=source_lamatic_google_drive_parsers,
